...
@section('frontend_content')
  <main class="main">
        {{-- <div class="page-header bg-dark"
          style="background-image: url('{{ asset('frontend_assets') }}/images/shop/page-header-back.jpg'); background-color: #3C63A4;">
          <h3 class="page-subtitle">Categories</h3>
          <h1 class="page-title">Grid 3 Columns</h1>
          <ul class="breadcrumb">
            ...
            <div class="row main-content-wrap gutter-lg">
                    ...
                    <div class="widget widget-collapsible">
                      ...
                      <ul class="widget-body filter-items search-ul">
                        @foreach ($categories as $category)
                          ...
                          <li ><a href="{{ url('categoryDetails') }}/{{ $category->id }}">{{ $category->name }}</a></li>
                        @endforeach
                          ...
                          <div class="products-col">
                            <div class="product product-list-sm">
                              <figure class="product-media">
                                <a href="product.html">
                                  <img src="{{asset('frontend_assets')}}/images/shop/product-widget1.jpg" alt="product"
                            ...
                            <div class="product product-list-sm">
                              <figure class="product-media">
                                <a href="product.html">
                                  <img src="{{asset('frontend_assets')}}/images/shop/product-widget2.jpg" alt="product"
                                    width="100" height="100">
                                </a>
                              </figure>
                              <div class="product-details">
                            ...
                            <div class="product product-list-sm">
                              <figure class="product-media">
                                <a href="product.html">
                                  <img src="{{asset('frontend_assets')}}/images/shop/product-widget3.jpg" alt="product"
                                    width="100" height="100">
                                </a>
                              </figure>
                              <div class="product-details">
              ...
              <div class="col-lg-9 main-content">
                    ...
                    <div class="product shadow-media">
                      <figure class="product-media">
                        ...
                        <div class="product-action">
                          <a href="{{ url('productDetails') }}/{{ $product->id }}" class="btn-product btn-quickview" title="Quick View">Quick
                            View</a>
                        </div>
                      </figure>
                      <div class="product-details">
                        ...
                        <div class="product-cat">
                          <a href="#">{{ App\Category::find($product->category_id)->name }}</a>
                        </div>
                        <h3 class="product-name">
                ...
                <div class="alert alert-danger">
                  <h4>{{ "There is no product available in this category!" }}</h4>
                </div>
                @endforelse
