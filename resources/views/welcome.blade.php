      ...
      <div class="page-content">
        @if (session('invalid_user'))
          <div class="alert alert-danger text-white">
            <span>{{ session('invalid_user') }}</span>
          </div>
        @endif
          <section class="intro-section">
              <div class="owl-carousel owl-theme row owl-dot-inner owl-dot-white intro-slider animation-slider cols-1 gutter-no"
                  ...
                  <div class="banner banner-fixed intro-slide1" style="background-color: #dddee0;">
                      <figure>
                          <div class="slide-effect">
                              <img src="{{ asset('frontend_assets') }}/images/demos/demo1/slides/Slider1_women.png"
                  ...
                  <div class="banner banner-fixed intro-slide2" style="background-color: #dddee0;">
                      <figure>
                          <img src="{{ asset('frontend_assets') }}/images/demos/demo1/slides/slide2.jpg" alt="intro-banner" width="1903"
                              height="630" />
                      </figure>
                      <div class="container">
                  ...
                  {{-- <div class="banner banner-fixed video-banner intro-slide3" style="background-color: #dddee0;">
                      <figure>
                          <video src="{{ asset('frontend_assets') }}/video/memory-of-a-woman.mp4" width="1903" height="630"></video>
                      </figure>
                      <div class="container">
                    ...
                    @foreach ($categories as $category)
                      <div class="col-md-3 col-6 mb-4">
                          <div
                              ...
                              <a href="{{url('categoryDetails')}}/{{ $category->id }}">
                                  <figure class="category-media">
                                      <img src="{{ asset('uploads/category') }}/{{ $category->photo }}" alt="category"
                                          width="280" height="280" />
                                  </figure>
                              </a>
                              <div class="category-content">
                                  <h4 class="category-name"><a href="{{url('categoryDetails')}}/{{ $category->id }}">{{$category->name}}</a></h4>
                              </div>
                          </div>
                      </div>
                    @endforeach
              ...
              {{-- <div class="owl-carousel owl-theme row owl-nav-full cols-2 cols-md-3 cols-lg-4" data-owl-options="{
                  ...
                  <div class="product">
                      <figure class="product-media">
                          <a href="product.html">
                              <img src="{{ asset('frontend_assets') }}/images/demos/demo1/products/product1.jpg" alt="Blue Pinafore Denim Dress"
              ...
              <div class="row">
                  <div class="col-lg-4 col-sm-6 mb-4">
                      <div class="banner banner-1 banner-fixed content-middle" data-animation-options="{
                          ...
                          <figure>
                              <img src="{{ asset('frontend_assets') }}/images/demos/demo1/banners/banner1.jpg" alt="banner" width="380"
                                  height="207" />
                          </figure>
          ...
          <section class="product-wrapper pb-10 container appear-animate" data-animation-options="{
              ...
              <div class="owl-carousel owl-theme row cols-2 cols-md-3 cols-lg-4 cols-xl-5" data-owl-options="{
                  ...
                  <div class="product">
                      <figure class="product-media">
                          <a href="product.html">
                              <img src="{{ asset('frontend_assets') }}/images/demos/demo1/products/product5.jpg" alt="Blue Pinafore Denim Dress"
          ...
          <section class="banner parallax" data-option="{'offset': 0}"
              data-image-src="{{ asset('frontend_assets') }}/images/demos/demo1/parallax.jpg" style="background-color: #44352d;">
          ...
          <section class="mt-3 pt-10 pb-10 appear-animate" data-animation-options="{
              ...
              <div class="container">
                  ...
                  <div class="owl-carousel owl-theme row brand-carousel cols-xl-6 cols-lg-5 cols-md-4 cols-sm-3 cols-2"
                      ...
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/1.png" alt="brand" width="180" height="100" />
                      </figure>
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/2.png" alt="brand" width="180" height="100" />
                      </figure>
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/3.png" alt="brand" width="180" height="100" />
                      </figure>
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/4.png" alt="brand" width="180" height="100" />
                      </figure>
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/5.png" alt="brand" width="180" height="100" />
                      </figure>
                      <figure><img src="{{ asset('frontend_assets') }}/images/brands/6.png" alt="brand" width="180" height="100" />
                      </figure>
                  </div>
              </div>
          </section>
